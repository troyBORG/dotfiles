...
echo -e "  • A pacman hook will automatically check space before kernel updates"
echo ""
echo -e "${BLUE}What happened before (for reference):${NC}"
echo -e "  • /boot/efi (2GB) filled up during kernel update"
echo -e "  • Kernel modules couldn't be built/installed properly"
echo -e "  • This caused 'Exec format error' when loading modules"
echo -e "  • System couldn't load 'fat' module to read /boot/efi"
echo -e "  • Result: boot.mount failed → emergency mode"
echo -e "  • ${GREEN}Now protected:${NC} 8GB partition + pre-update space check"
